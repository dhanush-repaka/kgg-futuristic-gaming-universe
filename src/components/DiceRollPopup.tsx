...
export default function DiceRollPopup() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent 
        className="max-w-4xl max-h-[90vh] overflow-y-auto bg-transparent border-0 shadow-none p-0 [&>button]:z-[60] [&>button]:bg-white/90 [&>button]:backdrop-blur-sm [&>button]:rounded-full [&>button]:w-8 [&>button]:h-8 [&>button]:flex [&>button]:items-center [&>button]:justify-center [&>button]:shadow-lg hover:[&>button]:bg-white"
