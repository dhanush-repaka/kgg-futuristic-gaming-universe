...
export default function KGGGamesShowcase() {
  ...
  return (
    <section ref={containerRef} id="games-showcase" className="py-32 perspective-1000 overflow-hidden border-t border-ink/8">
      <div className="mx-auto w-full max-w-7xl px-5 md:px-8">
        ...
        <motion.div
          style={{ y: yOffset }}
          className="hud-frame relative mt-12 overflow-hidden rounded-3xl border border-ink/8 bg-gradient-to-br from-surface to-surface-2 xl:aspect-[21/9] aspect-[16/9] transform-style-3d group"
        >
        ...
        <div className="mt-14 flex items-center justify-between">
          ...
          <div className="hidden gap-2 sm:flex">
            <button
              ...
              className="hud-frame flex h-10 w-10 items-center justify-center rounded-md border border-ink/10 bg-surface text-muted transition hover:text-ink"
            >
              <div className="hud-c2" />
        ...
        >
          {games.map((game, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="hud-frame group relative aspect-[3/4] w-[260px] shrink-0 snap-start overflow-hidden rounded-2xl border border-ink/8 bg-surface cursor-default sm:w-[280px]"
            >
              <div className="hud-c2" />
