...
export default function KGGHero() {
  return (
    <section id="home" className="relative overflow-hidden px-5 pb-20 pt-18 md:px-8 md:pt-24">
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="#pricing"
              className="rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-[0_12px_32px_rgba(56,189,248,0.38)] transition hover:scale-105"
            >
              Reserve Your Session
            </Link>
            <Link
              href="#gallery"
              className="rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm font-semibold text-slate-100 backdrop-blur-sm transition hover:border-cyan-300/60 hover:text-cyan-200"
            >
              Explore The Lounge
            </Link>
          </div>
        ...
        >
          <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-cyan-400/40 via-blue-500/35 to-violet-500/40 blur-2xl" />
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/8 p-3 backdrop-blur-xl">
            <Image
              src="/kgg-logo.jpeg"
              alt="Karthikeya's Games Galaxy logo"
              width={800}
              height={1000}
