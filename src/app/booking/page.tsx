...
function buildDateOptions(count = 10) {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      iso: toISODate(d),
      weekday: formatDayLabel(d),
      label: formatDayNum(d),
      isToday: i === 0,
    };
  });
}
  ...
  return (
    <div className="relative min-h-screen bg-bg text-ink">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 py-28 md:px-8 md:py-32">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-voltage/35 bg-voltage/10 px-3 py-1.5 text-xs font-semibold text-voltage">
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-ink-muted">
            Pick a plan and slot — we open WhatsApp pre-filled so we can confirm your night.
          </p>
        </motion.div>
        ...
        {!sent ? (
          ...
          >
            ...
            {/* Time — same tile height language */}
            <fieldset>
            ...
            {/* Party size — matches field height */}
            <div>
          ...
          <motion.div
            ...
            className="mt-10 rounded-xl border border-ink/15 bg-surface p-10 text-center"
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink-muted">
              Finish sending the pre-filled message and we&apos;ll confirm your{" "}
